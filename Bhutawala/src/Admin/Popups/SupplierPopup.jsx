                ...
                <div className='col-md-12 mb-2'>
                  <div className="row">
                    ...
                    <div className="col-md-4 mb-2">
                      ...
                      <textarea style={{ height: "50px" }} value={values.Address} onChange={handleChange} onBlur={handleBlur} id='Address' name='Address' className='form-control' placeholder='Address' />
                    </div>
                    <div className="col-md-4 mb-2">
                    ...
                    <div className="col-md-4 mb-2">
                      ...
                      <input type="text" value={values.AccountNo} onChange={handleChange} onBlur={handleBlur} id='AccountNo' name='AccountNo' className='form-control' placeholder='AccountNo' />
                    </div>
                    <div className="col-md-4 mb-2">
                      <b>Bank Name</b> <span className='text-danger'>*{errors.BankName}</span>
                      <input type="text" value={values.BankName} onChange={handleChange} onBlur={handleBlur} id='BankName' name='BankName' className='form-control' placeholder='BankName' />
                    </div>
                    <div className="col-md-4 mb-2">
