                ...
                <div className='col-md-6 mb-2'>
                  <div className="row">
                    ...
                    <div className="col-md-4 mb-2">
                      ...
                      <input type="text" value={values.BillNo} onChange={handleChange} onBlur={handleBlur}
                        id='BillNo' name='BillNo' className='form-control' placeholder='BillNo' />
                    </div>
                    <div className="col-md-4 mb-2">
                      <b>TransactionYear</b>&nbsp;<span className='text-danger'>* {errors.TransactionYearId}</span>
                      <select onChange={(e) => setContentValues("TransactionYearId", e.target.value)}
                        name="TransactionYearId" id="drpTransactionYearId" className='form-select'>
                    ...
                    <div className="col-md-3 mb-2">
                      ...
                      <input type="number" value={values.GST}
                        onChange={(e) => setContentsValues("GST", e.target.value)}
                        onBlur={handleBlur} id='GST' name='GST'
                        className='form-control' placeholder='GST' />
                    </div>
                    <div className="col-md-4 mb-2">
                      <b>GrossTotal</b> <span className='text-danger'>*{errors.GrossTotal}</span>
                      <input type="number" value={values.GrossTotal}
                        onChange={(e) => setContentsValues("GrossTotal", e.target.value)}
                        onBlur={handleBlur} id='GrossTotal' name='GrossTotal'
                        className='form-control' placeholder='GrossTotal' />
                    </div>
                    <div className="col-md-4 mb-2">
                      <b> NoticePeriod</b> <span className='text-danger'>*{errors.NoticePeriod}</span>
                      <input type="Date" value={values.NoticePeriod} onChange={handleChange} onBlur={handleBlur}
                        id='NoticePeriod' name='NoticePeriod' className='form-control' placeholder='NoticePeriod' />
                    </div>
                    <input type="number" value={values.Total || 0}
                      readOnly id='Total' name='Total'
