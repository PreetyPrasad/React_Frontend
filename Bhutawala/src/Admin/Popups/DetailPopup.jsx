              ...
              <div className="row">
                <div className="col-md-12 mb-4">
                  <div className="text-start">
                    ...
                    <span className='text-danger'>*{errors.MaterialId}</span>
                ...
                <div className="col-md-5 mb-2">
                  <label htmlFor="txtRate" className="form-label"><strong>Rate Of Material(₹) <span className='text-danger'>*{errors.Rate}</span></strong></label>
                  <div className="input-group">
                    <input type="text" className='form-control' onChange={handleChange} onBlur={handleBlur} name='txtRate' id='txtRate' placeholder='Rate of Material' value={`₹ ${Number(values.Price).toLocaleString("en-IN")}`} readOnly />
                ...
                <div className="col-md-1 mb-2 mt-2">
                  <label htmlFor="txtRate" className="form-label"><strong>   </strong></label>
                  <label className='form-control text-center'>X</label>
                </div>
                <div className="col-md-2 mb-2">
                  <label htmlFor="txtQty" className="form-label"><strong>Qty</strong> <span className='text-danger'>*{errors.Qty}</span></label>
                ...
                <div className="col-md-3 mb-2">
                  <label htmlFor="txtTotal" className="form-label"><strong>Total</strong><span className='text-danger'>*{errors.Total}</span></label>
                  <input type="text" className='form-control' name='txtTotal' id='txtTotal' value={`₹ ${Number(values.Total).toLocaleString("en-IN")}`} placeholder='₹ Total ' readOnly />
                </div>
